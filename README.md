...
由 [AI进化论-蒲公英](https://www.pugongying.ai/) 开发和维护。
...
关注我：
- [YouTube](https://www.youtube.com/@pugongying)
- [B站](https://space.bilibili.com/3493270982232856)
- [X(Twitter)](https://twitter.com/pugyongingai)
- [知乎](https://www.zhihu.com/people/pugongying)
- [个人主页](https://www.pugongying.ai/)
...
主要模块：
1. 规则管理器：负责规则文件的读写和管理
2. 命令处理器：处理VSCode命令面板和右键菜单命令
3. 规则合并器：处理规则文件的合并逻辑
4. UI交互：提供用户界面交互功能
